...
Matrix4.prototype = {
	...
	multiply: function(rightSideMatrix) {
		...
		{
			var result = 0;
			var Maxj = Math.floor(i/4) * 4 + 4;
			//行就是J
			for(var j = Math.floor(i/4) * 4, z = i % 4; j < Maxj; j++, z = z + 4)
			{
				result += this.elements[j] * rightSideMatrix.elements[z];

				console.log("j is " + j + " z is " + z)
				console.log("left elements " + this.elements[j]);
				console.log("right elements " + rightSideMatrix.elements[z]);
