...
function createScene() {
    ...
    groundGeometry.worldMatrix.multiply(RotationX).multiply(Scale);
...
function updateAndRender() {
    ...
    gl.uniform4f(colorProgram.uniforms.colorUniform, 0.5, Math.sin(time.secondsElapsedSinceStart), Math.sin(time.secondsElapsedSinceStart), 1.0);
