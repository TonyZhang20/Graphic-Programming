...
function createShaders(loadedAssets) {
    ...
    textureShaderProgram.attributes = {
        ...
        vertexMyTexcoordsAttribute: gl.getAttribLocation(textureShaderProgram, "aMyTexcoords")
    };
    ...
    textureShaderProgram.uniforms = {
        ...
        mytextureUniform: gl.getUniformLocation(textureShaderProgram, "vMyTexcoords"),
